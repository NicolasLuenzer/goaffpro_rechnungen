...
# Der bereinigte Kontext darf .git enthalten, muss es für Portainer-Builds aber nicht.
# .dockerignore hält lokale Zugangsdaten und Bestandsdaten aus dem Kontext heraus.
COPY . .
