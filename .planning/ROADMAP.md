...
Plans:
- [x] 02-01-PLAN.md — 7 trivial fixes: favicon, login form, API-key masking, label color, date layout, chart empty states, color picker sizing
- [x] 02-02-PLAN.md — CSS token migration (hardcoded hex to custom properties) + Zahllauf-pill collapse toggle
- [x] 02-03-PLAN.md — Typography scale consolidation (8 sizes to 4-step scale via CSS tokens)
